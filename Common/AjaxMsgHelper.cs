...
namespace Common
{
    ...
    public static class AjaxMsgHelper
    {
        ...
        /// <param name="nextUrl"></param>
        /// <returns></returns>
        public static void AjaxMsg1(string statu, string msg, string data, string nextUrl)
        {
            //{"statu":"err","msg":"出错啦~~","data":[{},{}],"nextUrl":"Login.aspx"}
            string strMsg = "{\"statu\":\"" + statu + "\",\"msg\":\"" + msg.Replace('"', ' ').Replace('\'', ' ').Replace("\r\n", "") + "\",\"data\":" + (data == null ? "null" : data) + ",\"nextUrl\":" + (nextUrl == null ? "null" : "\"" + nextUrl + "\"") + "}";
            //直接输出 数据 到 浏览器
        ...
        /// <param name="nextUrl"></param>
        /// <returns></returns>
        public static void AjaxMsg2(string statu, string msg, string data, string nextUrl)
        {
            //{"statu":"err","msg":"出错啦~~","data":[{},{}],"nextUrl":"Login.aspx"}
            string strMsg = "{\"statu\":\"" + statu + "\",\"msg\":\"" + msg.Replace('"', ' ').Replace('\'', ' ').Replace("\r\n", "") + "\",\"data\":\"" + (data == null ? "null" : data) + "\",\"nextUrl\":" + (nextUrl == null ? "null" : "\"" + nextUrl + "\"") + "}";
            //直接输出 数据 到 浏览器
