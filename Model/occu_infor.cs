...
{
    /// <summary>
    /// occu_infor:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class occu_infor
    {
        ...
        private string _tuifaId;
        private string _userid;
        private int _occ_StyDate;
        public string Accounts { get; set; }
        public int? CpID { get; set; }
        public DateTime? Occ_TfTime { get; set; }
        public string GzRoom { get; set; }
        public int Occ_StyDate
        {
            get { return _occ_StyDate; }
            set { _occ_StyDate = value; }
        }
        private string _occ_headerImg;

        public string Occ_headerImg
        {
            get { return _occ_headerImg; }
            set { _occ_headerImg = value; }
        }
        ...
        public string tuifaId 
        {
            set { _tuifaId = value; }
            get { return _tuifaId; }
        }
        
        private Model.real_mode real_mode_mode;

        public Model.real_mode Real_mode_mode
        {
            get { return real_mode_mode; }
            set { real_mode_mode = value; }
        }

        private Model.hourse_scheme hourse_scheme_model;

        public Model.hourse_scheme Hourse_scheme_model
        {
            get { return hourse_scheme_model; }
            set { hourse_scheme_model = value; }
        }

        private Model.room_type room_type_model;

        public Model.room_type Room_type_model
        {
            get { return room_type_model; }
            set { room_type_model = value; }
        }
        ...
        private Model.card_type card_type_model;

        public Model.card_type Card_type_model
        {
            get { return card_type_model; }
            set { card_type_model = value; }
        }
