...
{
    public partial class Roomsmoshi : System.Web.UI.Page
    {
        ...
        public void BindGV() 
        {
            ...
            string Div = "";
              ...
              {
                  Div += "<div class='lin'><span>" + dr["moshi_name"] + "<span onclick=\"OpenBc(this," + dr["id"].ToString() + ")\" style='padding-top:3px;padding-left:5px;'><img style='width:15px;height:15px;' src=\"../../images/iconbj.png\" /></span> <em onclick=\"BookEancel(" + dr["id"].ToString() + ",0)\">x</em></div>";
              }
