<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopBanc.aspx.cs" Inherits="CdHotelManage.Web.Admin.Menus.ShopBanc" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenBc(obj, ids) {
            var url = "shoppupdate.aspx?id=" + ids;
            showMyWindow("修改班次", url, 400, 120, true, true, true);
        }
    </script>
</head>
<body>
