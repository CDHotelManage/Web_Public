<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMenu.aspx.cs" Inherits="CdHotelManage.Web.Admin.Permissions.menu.EditMenu" %>
...
<body style=" overflow:hidden;">
  ...
  　　　<li>菜 单 名 ：<asp:TextBox runat="server" ID="txttitle"></asp:TextBox>
        ...
        <li>启　　用：<span class="rad"><asp:RadioButtonList ID="radable" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
