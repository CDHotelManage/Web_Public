<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editbanner.aspx.cs" Inherits="CdHotelManage.Web.Admin.banner.editbanner" %>
...
<body>
  ...
  　　　<div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;标题：
	    ...
	    <div>选择图片：
            ...
            <asp:Label ID="labimg" runat="server"></asp:Label>
        </div>
